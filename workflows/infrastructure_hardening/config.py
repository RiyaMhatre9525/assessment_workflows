...
Scoring (0.0-1.0):
  ...
  - 0.5: Partial pass — some criteria fully met, others missing.
  - 0.8: Most criteria met, minor gaps (e.g. MFA + encryption present but no documented review process).
...
Respond ONLY with valid JSON:
{
  ...
  "recommendations": [
    {"gap": "<specific security capability gap>", "action": "<concrete action>", "priority": "<high|medium|low>", "estimated_effort": "<low|medium|high>", "related_level": 1}
  ]
}
"""
